...
window.onload = function(){
    ...
    */
    ...
    for (var i = 0; i < containers.length; i++) {
        containers.item(i).style.height = winHeight + "px";
        if (i % 2 === 0) {
            containers.item(i).style.background = "transparent";
        } else {
            containers.item(i).style.background = colorArray[Math.floor(Math.random() * 10)];
        }
    }
    ...
    function refreshPage() {
        main.style.transform = "translateY(" + nowHeight + "px" + ")";
    }
    ...
    next.addEventListener('click', function () {
        // console.log(nowHeight);
        if (nowHeight <= -winHeight * (containers.length-1)) {
